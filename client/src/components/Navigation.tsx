...
import { Home, Hand, MessageCircle, UserCircle, Mic2 } from "lucide-react";
          ...
          {navItems.map(({ href, icon: Icon, label, testId }) => {
            ...
            return (
              <Link key={href} href={href}>
                <div 
                  className={`flex flex-col items-center px-4 py-2 rounded-lg transition-all cursor-pointer ${
                    isActive 
                      ? "text-electric-cyan" 
